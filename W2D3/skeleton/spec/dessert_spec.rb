...
describe Dessert do
  let(:chef) { double("chef",name: "Boyardi") }
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect(Dessert.new("ice cream","scoop",chef)).to raise_error(ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ...
      cake.mix!
      expect(cake.ingredients).not_to eq(["flour","sugar","egg","milk"])
    end
  end
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect {cake.eat(35)}.to raise_error("not enough left!")
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(cake.serve).to eq("Chef Boyardi the Great Baker has made 100 cakes!")
    end
  end
